...
export const VerifUserModal = ({ isOpen, onClose, onConfirm }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,0.9)] backdrop-blur-sm transition-opacity duration-300 ease-in-out">
            ...
            >
                ...
                <h3 className="mt-5 text-2xl font-bold text-center text-gray-800">
                    Konfirmasi Verifikasi Pengguna
                </h3>
                
                {/* Pesan Deskripsi */}
                <p className="mt-3 text-base text-center text-gray-600">
                    Apakah Anda yakin ingin memverifikasi pengguna ini? Setelah diverifikasi, pengguna akan memiliki hak akses penuh untuk <strong>menambah, mengubah, dan menghapus data.</strong>
                </p>
